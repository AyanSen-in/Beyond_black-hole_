...
# # image= qr.make=input(" enter your ")
# # image.save(f"{qr.make}.png")
...
#             qr_code = cast(Image.Image, qrcode.make(qr_data))
#             # print(qr_code)
#             qr_code = qr_code.resize((180, 180), Image.Resampling.LANCZOS)
